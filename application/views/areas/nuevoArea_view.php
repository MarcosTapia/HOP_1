...
<body>      
    <div class="container"> <!--class="container-fluid" -->
        <div class="row-fluid">
            ...
            <div class="col-sm-6">
                <form onsubmit="javascript:return verificaCampos();" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/areas_controller/nuevoAreaFromFormulario" method="post">
                    <br>
                    <h4>Alta de &Aacute;rea</h4>
                    <br>
